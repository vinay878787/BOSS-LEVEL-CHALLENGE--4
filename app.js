...
app.get('/category/:postID', (req, res) => {
  const postIdReq = _.lowerCase(req.params.postID);
  const NAME = _.lowerCase(journalModel.Name);

  journalModel.findOne({NAME: postIdReq }, (err, blogs) => {
    res.render('post', {
      Name: blogs.Name,
